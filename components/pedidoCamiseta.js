...
export default function Camiseta(props) {
    ...
    id = props.camiseta.id_camiseta;
    descripcion = props.camiseta.descripcion;
    imagen = props.camiseta.imagen;
    precio = props.camiseta.precio;
    talles = props.camiseta.talles.split(' ');
